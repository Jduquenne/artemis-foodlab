...
export const CopyModeBar = ({ recipeName, selectedCount, pending, onConfirm, onCancel }: CopyModeBarProps) => (
    <div className="shrink-0 flex items-center justify-between gap-3 px-3 py-2 bg-violet-500 text-white rounded-xl">
        ...
        <div className="flex items-center gap-2 shrink-0">
            ...
            <button
                onClick={onCancel}
                disabled={pending}
                className="p-1.5 hover:bg-violet-600 rounded-lg transition-colors disabled:opacity-40"
            >
                <X size={16} />
            </button>
        </div>
